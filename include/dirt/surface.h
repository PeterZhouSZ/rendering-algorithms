...
public:
    ...
    */
    ...
    // sample a direction from o toward this surface
    virtual Vec3f sample(const Vec3f& o) const
    {
        return Vec3f(0.0f, 0.0f, 0.0f);
    }

    // return the pdf of the sample generated by \ref sample
    ...
    virtual void SampleFromEmit(Vec3f &pos, Vec3f &dir) const {};
